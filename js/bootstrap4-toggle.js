...
(($) => {
	...
	Toggle.prototype.render = function () {
		...
		const $toggleGroup = $('<div class="toggle-group">')
			.append($toggleOn, $toggleOff, $toggleHandle);

		const $toggle = $('<div class="toggle btn" data-toggle="toggle" role="button">')
		...
		const width = this.options.width || Math.max($toggleOn.outerWidth(), $toggleOff.outerWidth()) + ($toggleHandle.outerWidth() / 2);
		const height = this.options.height || Math.max($toggleOn.outerHeight(), $toggleOff.outerHeight());
